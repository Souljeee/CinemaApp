...
class PopularAdapter(private var onItemViewClickListener: MainFragment.OnItemViewClickListener?): RecyclerView.Adapter<PopularAdapter.ViewHolder>() {

    private lateinit var holder : PopularAdapter.ViewHolder
