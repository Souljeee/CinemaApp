...
class UpcomingAdapter(private var onItemViewClickListener: MainFragment.OnItemViewClickListener?):RecyclerView.Adapter<UpcomingAdapter.ViewHolder>() {

    private lateinit var holder : UpcomingAdapter.ViewHolder
